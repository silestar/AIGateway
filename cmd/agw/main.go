...
func main() {
	...
	agwapi.NewChannelHandler(channelSvc, accountMgr, asyncWriter, cache).RegisterRoutes(protected)
	agwapi.NewAccountHandler(accountMgr, cache).RegisterRoutes(protected)
	...
	agwapi.NewSystemHandler(cfg, accountMgr, db).RegisterRoutes(protected)
